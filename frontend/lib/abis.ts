...
export const diceGameAbi = [
  ...
  "function houseEdgeBps() view returns (uint16)",
  "function revealWindow() view returns (uint32)",
  "function previewPayout(uint256 amount, uint8 rollUnder) view returns (uint256)",
...
export const lotteryGameAbi = [
  ...
  "function owner() view returns (address)",
  "function maxWaitForFulfill() view returns (uint32)",
